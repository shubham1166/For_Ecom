clc,clear
function [numCust,Completed,numArrival] = JobsDone(lambda,u,x,arrivals)
Queue = x-1;
...
numCust = []
[numCust jobs arr]= JobsDone(0.1,2,1,20000)
disp(strcat(["Stationary expected number of customers in an MM1 ",string(mean(numCust(:,2)))]))
